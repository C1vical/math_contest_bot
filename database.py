...
def load_problems(year, contest, edition, problem_numbers):
    """Load the problems into the database."""
    problem_set = fetch_aops_problem_set(year, contest, edition)
    for question_number in range(1, problem_numbers + 1):
        add_problem(contest, year, edition, question_number, problem_set[question_number-1], 0)
